      ...
      <?php if($_SESSION['access']&0b111100){?>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-left">
            ...
            <li><a href="/psa_hris/view-time.php">Time Records</a></li>
        ...
        <div class="modal-body">
          ...
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <td><input class="form-control oldPasswordField" type="password" required></td>
            </tr>
            <tr>
              <td><strong>New Password</strong></td>
              <td><input name="newPassword" class="form-control changePasswordField" type="password" required minlength=8></td>
            </tr>
            <tr>
              <td><strong>Confirm Password</strong></td>
              <td><input class="form-control changePasswordField" type="password" required></td>
            </tr>
          </table>

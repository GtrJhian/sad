    ...
    if(isset($_GET['table'])){
        ...
        if($table=='agency'){
            ...
            for($ctr=0; $ctr<count($data); $ctr++){
                $data[$ctr][2]="<button type='button' onclick='viewAgency(".$data[$ctr][2].")' class='btn btn-primary' data-toggle='modal' data-target='#viewagencymodal'><span class='glyphicon glyphicon-eye-open' style='margin-right: 4px'></span>View Agency Details</button>";
            }
            $results = array(
                    "sEcho" => 1,

            ...
            <table id="example" class="table table-hover table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td style="text-align:center;"> 
                        <button type="button" class="viewModal btn btn-primary" data-target="#viewModal" data-toggle="modal"  data-id="<?php echo $assoc['account_id']; ?>" > 
                            <span class="glyphicon glyphicon-eye-open"></span>View Account Summary
                        </button></td>
                    </tr> 
                <?php } ?>
                </tbody>
    ...
    <div class="modal-content">
        ...
        <form class="form-horizontal" id="addForm" action="accountsCRUD.php" method="POST">
            <div class="modal-header">
                ...
                <h3 class="modal-title pull-left">Add Account</h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal">
                    <strong class="glyphicon glyphicon-ban-circle" style="margin-right: 4px;"></strong>
                    Cancel
                </button>
            </div>
        </form>
...
<div class="modal-lg modal-dialog">
    <div class="modal-content">
        <form class="form-horizontal" id="viewForm" action="accountsCRUD.php" method="POST">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal">
                <span class="glyphicon glyphicon-remove" style="margin-left: 4px;"></span>
                    Close
                </button>
            </div>
        </form>
